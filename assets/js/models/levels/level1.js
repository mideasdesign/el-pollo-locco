const level1 = new Level(
    ...
    [
        ...
        new BackgroundObject('assets/images/5_background/layers/air.png', 1438),
        new BackgroundObject('assets/images/5_background/layers/3_third_layer/1.png', 1439),
        new BackgroundObject('assets/images/5_background/layers/2_second_layer/1.png', 1438),
        new BackgroundObject('assets/images/5_background/layers/1_first_layer/1.png', 1339),
