...
class AudioHub {
  ...
  static background = new Audio(
    "./assets/sound/tex-mex-delight-mexican-mariachi.mp3"
  );
  ...
  static chickenSound = new Audio(
    "./assets/sound/668804__mbpl__chicken-clucking-2.wav"
  );
  ...
  static pepeSound = new Audio(
    "./assets/sound/804622__qubodup__young-man-hurt-voice.wav"
  );

  /** @type {Audio} - Game over sound effect */
  static gameoverSound = new Audio(
    "./assets/sound/439890__simonbay__lushlife_gameover.wav"
  );
  ...
  static gamewinSound = new Audio(
    "./assets/sound/brass-fanfare-with-timpani-and-winchimes-reverberated-146260.mp3"
  );
  ...
  static allSounds = [
    AudioHub.background,
    AudioHub.coinSound,
    AudioHub.bottleSound,
    AudioHub.chickenSound,
    AudioHub.chicksSound,
    AudioHub.pepeSound,
    AudioHub.gameoverSound,
    AudioHub.youwinSound,
    AudioHub.youlooseSound,
    AudioHub.gamewinSound,
    AudioHub.attackSound,
    AudioHub.endbossHurtSound,
  ];
  ...
  static async testAudioPlayback() {
    const testAudio = new Audio(
      "data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmMZBjWH1/LNeCwFJHPD8N2QQAoUXrXp66hVFApGnt/yv2UaB"
    );
    try {
  ...
  static handleBackgroundMusic() {
    if (
      !AudioHub.pausedSounds.has(AudioHub.background) &&
