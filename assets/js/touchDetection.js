...
function configureTouchMode(elements) {
    if (elements.touchControls) elements.touchControls.classList.add('show-touch-controls');
    if (elements.desktopInstructions) elements.desktopInstructions.style.display = 'none';
...
function configureMouseMode(elements) {
    if (elements.touchControls) elements.touchControls.classList.remove('show-touch-controls');
    if (elements.desktopInstructions) elements.desktopInstructions.style.display = 'flex';
